/* BUILD v20260908h — EXACTLY like the reference video: a curtain pulled UP.
...
(function(){
  ...
  var VEIL   = '#6b6a70';           // dimmed warm gray veil (was #c9c6cd ~flash)
  var VEIL_RGB = [0.420, 0.416, 0.439];
