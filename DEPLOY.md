...
3. Uji lokal: `python3 -m http.server 8080`.
   ...
   intro work: LQIP instan lalu kocok ±2 dtk (wload hilang, counter jalan) ·
...
2. Runtime desktop + mobile: 7 halaman 0 console/page error, 0 request gagal;
   loader home selesai; intro work main instan (LQIP) lalu kocok ±2 dtk; toggle LOG, filter full, palette cmd+k,
